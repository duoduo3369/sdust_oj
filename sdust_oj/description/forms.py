...
from sdust_oj.description.widgets import DescriptionMetaItemRelationCombinationField    
class DescriptionMetaItemRelationCombinationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.description_meta_item_relation_info_list = kwargs["initial"]["description_meta_item_relation_info_list"]
        for obj in self.description_meta_item_relation_info_list:
            self.fields[obj.title_field_name] = DescriptionMetaItemRelationCombinationField(label=_(obj.item_relation_title),required=False)
    ...
    def save(self, commit=True, update=False,
        ...
        for obj in self.description_meta_item_relation_info_list:
            ...
            choice_list.append(field_info_list[0])
            if field_info_list[0] == 'True' :
                if field_info_list[1] != 'None':
                    #description_meta_item_relation_combination --> obj_dmitrc
